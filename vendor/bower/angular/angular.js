...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * pre-configured with strategies that address these issues, but for this to work IRISORG server
...
// });
  ...
  it('should make JSONP request to invalid URL and invoke the error handler',
    ...
    function sendReq(config, reqData) {
      ...
      // send the request to the IRISORG
 ...
 *
 * @description
 * HTTP IRISORG used by the {@link ng.$http service} that delegates to
