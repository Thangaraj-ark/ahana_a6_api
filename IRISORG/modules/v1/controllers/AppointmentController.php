 ...
 */
class AppointmentController extends BaseActiveController {
            ...
            if ($valid) {
                ...
                if (!empty($post['charge_subcat_id'])) {
                    foreach ($post['charge_subcat_id'] as $key => $value) {
                        ...
                        $procedure->encounter_id = $post['encounter_id'];
                        $procedure->patient_id = $post['patient_id'];
                        $procedure->charge_subcat_id = $value;
                        $procedure->proc_date = $post['proc_date'];
                        $procedure->proc_consultant_ids = array($appt_model->consultant_id);
